  ...
  { name: "superiority-strict", ok: () => run("node", ["scripts/provider-superiority.mjs", "--strict"]) },
  {
    ...
    ok: () =>
      run("node", [
        ...
        "src/lib/engines/__tests__/searchops-ai-visibility-miner.test.ts",
        "src/lib/engines/__tests__/searchops-authority-miner.test.ts",
        "src/lib/engines/__tests__/searchops-task-loop.test.ts",
        "src/lib/engines/__tests__/searchops-after-metric.test.ts",
        "src/lib/engines/__tests__/searchops-export.test.ts",
        "src/lib/engines/__tests__/gsc-query-snapshots.test.ts",
        ...
        "src/app/api/__tests__/provider-proof-route.test.ts",
