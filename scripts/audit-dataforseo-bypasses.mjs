...
const FILE_META = {
  ...
  "src/lib/engines/ppc-intelligence.ts": {
    ...
    budgetGuard: "transitive",
    cancellationGuard: true,
    migration: "Shot 2: routeSerpIntelligence + getCachedRealKeywordCpc",
    priority: "P3",
  },
  "src/lib/engines/backlink-monitor.ts": {
    ...
    budgetGuard: "transitive",
    cancellationGuard: false,
    migration: "Shot 2: backlink-intelligence wrapper + fetchBacklinks",
    priority: "P3",
  },
  "src/lib/engines/authority-finder.ts": {
    ...
    budgetGuard: "transitive",
    cancellationGuard: false,
    migration: "Shot 2: routeReferringDomains; resolveCompetitorDomainFree only",
    priority: "P3",
  },
  "src/app/api/serp-explorer/route.ts": {
    ...
    budgetGuard: "transitive",
    cancellationGuard: false,
    migration: "Shot 2: routeSerpIntelligence",
    priority: "P3",
  },
